...
U_NP,              U_NP,              U_LT(U_MEDIA, LGUI),&mo U_NAV,        U_LT(U_MOUSE, SPACE),U_LT(U_SYM, RET), U_LT(U_NUM, ESC),  U_LT(U_FUN, DEL),  U_NP,              U_NP
...
&kp A,             &kp S,             &kp D,             &kp F,             &kp G,             &kp H,             &kp J,             &kp K,             &kp L,             &kp SQT,           \
&kp Z,             &kp X,             &kp C,             &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         &kp DOT,           &kp SLASH,         \
U_NP,              U_NP,              &kp LGUI,          U_NA,              &kp TAB,           &kp RET,           U_LT(U_NUM, ESC), &kp DEL,           U_NP,              U_NP
...
&kp F12,           &kp F7,            &kp F8,            &kp F9,            &kp PSCRN,         &sys_reset,         &u_to_U_BASE,      &u_to_U_EXTRA,        &u_to_U_TAP,       U_BOOT,            \
